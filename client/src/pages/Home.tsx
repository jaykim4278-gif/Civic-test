      ...
      <main className="max-w-4xl mx-auto px-6 py-8 space-y-10">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Link href="/n400">
              <div className="bg-white p-6 rounded-3xl border-2 border-slate-100 shadow-sm hover:border-emerald-200 cursor-pointer transition-colors flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-500 text-sm">
                    Interview questions · 영어 음성
                  </p>
                </div>
                <ArrowRight className="w-5 h-5 text-slate-300" />
              </div>
            </Link>
            <Link href="/n400-vocab">
              <div className="bg-white p-6 rounded-3xl border-2 border-slate-100 shadow-sm hover:border-emerald-200 cursor-pointer transition-colors flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-emerald-50 text-emerald-500 flex items-center justify-center">
